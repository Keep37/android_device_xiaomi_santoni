...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/ubuntu/fix_pulseaudio.sh:system/halium/etc/init/fix_pulseaudio.sh \
...
#    $(LOCAL_PATH)/ubuntu/70-santoni.rules:usr/lib/lxc-android-config/70-santoni.rules 
